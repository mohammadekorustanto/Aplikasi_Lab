                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" action="<?= base_url('auth/daftar'); ?>" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="mapel" placeholder="Mapel..." autocomplete="off" name="mapel" value="<?= set_value('mapel'); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user" id="password2" placeholder="Komfirmasi Password" name="password2">
                                </div>
                            </div>
